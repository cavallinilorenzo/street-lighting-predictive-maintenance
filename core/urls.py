...
urlpatterns = [
    ...
    path('dettaglio-intervento/<path:tipo_intervento>/', dettaglio_intervento, name='dettaglio_intervento'),
    path('asset/<int:pk>/aggiuntaInterventiApi', aggiuntaInterventiApi, name='aggiuntaInterventiApi'),
]